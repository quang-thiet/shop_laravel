    ...
    <div class="col-md-12">
        <div class="card card-custom gutter-b example example-compact">
            <div class="card-header">
                <h3 class="card-title">ADD Surcharge </h3>
            </div>
            <!--begin::Form-->
            <form method="POST" enctype="multipart/form-data" action="{{ route('voucher.store')}}">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                      <label>Code
                          <span class="text-danger">*</span></label>
                      <input type="text" value="{{ old('value') }}" name="code" class="form-control" placeholder="Nhập giá trị ">
                      @error('code')
                          <p class="text-danger">{{$message}}</p>    
                      @enderror
                  </div>
                    <div class="form-group">
                        ...
                        <a href="{{ route('surcharge.index') }}" class="btn btn-success mr-2">list Voucher</a>
                    </div>
                </div>
            </form>
            <!--end::Form-->
